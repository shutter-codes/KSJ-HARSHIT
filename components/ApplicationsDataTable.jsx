    ...
    },
    {
      ...
      selector: (row) => (
        <button
          ...
          className=" w-20 py-2 text-xs text-indigo-600 hover:text-white my-2 hover:bg-slate-700 border border-indigo-600 rounded transition-all duration-700"
        >
          Download
        </button>
      ),
      ...
      cell: (row) => (
        <div className="flex items-center justify-start w-72 h-20">
          <button
            ...
            className=" w-20 py-2 mx-2 text-xs text-indigo-600 hover:text-white my-2 hover:bg-slate-700 border border-indigo-600 rounded transition-all duration-700"
          >
            Details
          </button>
          <button
